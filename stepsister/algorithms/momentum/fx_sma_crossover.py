"""SMA Crossover with volatility scaling for forex."""
...
class FXSMACrossover(BaseAlgorithm):
    """Simple Moving Average crossover for forex pairs.
    ...
    def generate_signal(self, data: pd.DataFrame, symbol: str) -> Optional[Signal]:
        ...
        strength = min(spread_pct * 100, 1.0)
