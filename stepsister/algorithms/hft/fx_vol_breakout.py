"""ATR volatility breakout for forex on M1 bars.
...
Inspired by the squeeze/expansion dynamics observed in major FX pairs
during transitions between Asian/European/US sessions.

Volume confirmation disabled — tick volume is unreliable in spot FX.
"""
...
class FxVolBreakout(BaseAlgorithm):
    """Volatility compression -> breakout strategy on M1 forex bars.
    ...
    Volume confirmation disabled for FX.
    """

    name = "fx_vol_breakout"
    ...
    def generate_signal(self, data: pd.DataFrame, symbol: str) -> Optional[Signal]:
        ...
        # Volume confirmation disabled for forex — tick volume unreliable
